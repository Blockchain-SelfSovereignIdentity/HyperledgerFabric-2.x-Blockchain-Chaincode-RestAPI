...
* Verificação:
    ...
    ```
### Docker (19.03.12 - compatível com Fabric 2.3.1)
...
* Istalar (docker-compose version 1.29.2 - Compatível com Fabric 2.3.1):
```shell
...
### Importando os binários do Fabric (É necessário instalar exatamente a versão 2.3.1, devido à compatibilidade com os outros componentes)
Mais atualizada: curl -sSL https://bit.ly/2ysbOFE | bash -s
